    ...
    namespace experimental
    {
        namespace test
        {
            ...
            struct ElementMock : refract::experimental::IElement, tracked<ElementMock> {
                ...
                refract::experimental::InfoElements meta_out;
                refract::experimental::InfoElements& meta() noexcept override
                {
                    ++_total_ctx;
                    ++meta_ctx;
                    return meta_out;
                ...
                refract::experimental::InfoElements meta_const_out;
                const refract::experimental::InfoElements& meta() const noexcept override
                {
                    ++_total_ctx;
                    ++meta_const_ctx;
                ...
                refract::experimental::InfoElements attributes_out;
                refract::experimental::InfoElements& attributes() noexcept override
                {
                    ++_total_ctx;
                    ++attributes_ctx;
                ...
                refract::experimental::InfoElements attributes_const_out;
                const refract::experimental::InfoElements& attributes() const noexcept override
                {
                    ++_total_ctx;
